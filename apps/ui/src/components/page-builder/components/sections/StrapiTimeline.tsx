      ...
      <div className={cn("min-w-0 flex-1 pb-4 lg:pb-8", isLast && "pb-0")}>
        ...
        {item.description && (
          <HtmlContent
            ...
            className="prose prose-sm lg:prose-lg prose-img:w-full lg:prose-img:w-2/5 max-w-none text-gray-600 [--tw-prose-body:inherit] [--tw-prose-bold:inherit] [--tw-prose-bullets:inherit] [--tw-prose-captions:inherit] [--tw-prose-code:inherit] [--tw-prose-counters:inherit] [--tw-prose-headings:inherit] [--tw-prose-links:inherit]"
          />
        )}
